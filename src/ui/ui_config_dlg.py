...
class Ui_ConfigDlg(object):
    def setupUi(self, ConfigDlg):
        ...
        self.tabGobyted = QtWidgets.QWidget()
        self.tabGobyted.setObjectName("tabGobyted")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.tabGobyted)
        self.verticalLayout_3.setContentsMargins(3, 3, 3, 3)
        self.verticalLayout_3.setSpacing(3)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.label_2 = QtWidgets.QLabel(self.tabGobyted)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_3.addWidget(self.label_2)
        self.cboGoByteNetwork = QtWidgets.QComboBox(self.tabGobyted)
        self.cboGoByteNetwork.setObjectName("cboGoByteNetwork")
        self.cboGoByteNetwork.addItem("")
        self.cboGoByteNetwork.addItem("")
        self.horizontalLayout_3.addWidget(self.cboGoByteNetwork)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem)
        self.verticalLayout_3.addLayout(self.horizontalLayout_3)
        self.frame_2 = QtWidgets.QFrame(self.tabGobyted)
        ...
        self.tabWidget.addTab(self.tabGobyted, "")
    ...
    def retranslateUi(self, ConfigDlg):
        ...
        self.label_2.setText(_translate("ConfigDlg", "GoByte network:"))
        self.cboGoByteNetwork.setItemText(0, _translate("ConfigDlg", "MAINNET"))
        self.cboGoByteNetwork.setItemText(1, _translate("ConfigDlg", "TESTNET"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabGobyted), _translate("ConfigDlg", "GoByte network"))
        ...
        self.chbDownloadProposalExternalData.setText(_translate("ConfigDlg", "Download external proposal attributes (Central.GoByteNation.org)"))
