...
# Form implementation generated from reading ui file '/Users/blogin/PycharmProjects/GMT-git/src/ui/ui_main_dlg.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.edtMnCollateralTx.setToolTip(_translate("MainWindow", "The collateral transaction hash from the 1000 Gobyte deposit"))
        self.label_7.setText(_translate("MainWindow", "TX index:"))
        self.edtMnCollateralTxIndex.setToolTip(_translate("MainWindow", "The collateral transaction\'s (unspent) output index with the 1000 Gobyte deposit (usally 0)"))
        self.edtMnCollateralAddress.setToolTip(_translate("MainWindow", "Gobyte address of the 1000 Gobyte collateral, coverted from BIP32 path with hardware wallet."))
        self.edtMnCollateralAddress.setPlaceholderText(_translate("MainWindow", "Gobyte address"))
        self.btnHwAddressToBip32.setToolTip(_translate("MainWindow", "Convert Gobyte address to BIP32 path using hardware wallet"))
        self.btnHwBip32ToAddress.setToolTip(_translate("MainWindow", "Convert BIP32 path to Gobyte address using hardware wallet"))
        self.edtMnCollateralBip32Path.setToolTip(_translate("MainWindow", "BIP32 path of the 1000 Gobyte collateral (e.g. 44\'/176\'/0\'/0/0)"))
        ...
        self.action_check_network_connection.setToolTip(_translate("MainWindow", "Check Gobyte Network Connection"))
        ...
        self.action_about_app.setText(_translate("MainWindow", "About GobyteMasternodeTool..."))
