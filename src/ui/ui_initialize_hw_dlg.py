...
""))
        ...
        self.chbHwOptionsUsePassphrase.setWhatsThis(_translate("HwInitializeDlg", "<html><head/><body><p>Check the link attached &lt;a href=&quot;gobyte.network&quot;&gt;gobyte.network&lt;/a&gt;</p></body></html>"))
        ...
        self.edtHwOptionsBip32Path.setText(_translate("HwInitializeDlg", "44\'/176\'/0\'/0/0"))
        self.label_5.setText(_translate("HwInitializeDlg", "GoByte addresses which will be available in the device after finishing the process:"))
...
"For an official firmware, you can uncheck this option."))
        ...
        self.label_2.setText(_translate("HwInitializeDlg", "<a href=\"https://github.com/D0WN3D/gobyte-masternode-tool/blob/master/doc/hw-initialization-recovery.md\">Read the documentation on GitHub</a>"))
